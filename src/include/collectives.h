...
#define ALLREDUCE_SLICESTEPS (NCCL_STEPS/16)
#define ALLREDUCE_CHUNKSTEPS (NCCL_STEPS/8)
#define ALLGATHER_SLICESTEPS (NCCL_STEPS/16)
#define ALLGATHER_CHUNKSTEPS (NCCL_STEPS/8)
#define REDUCESCATTER_SLICESTEPS (NCCL_STEPS/16)
#define REDUCESCATTER_CHUNKSTEPS (NCCL_STEPS/8)
